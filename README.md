...
* 게임 구성 디렉터리 및 파일의 해시 검사를 통해 유효성 검사를 하여 위변조를 막고 일관적인 게임 서비스를 제공합니다.  
* 다운로드 진행 상황을 시각적으로 확인할 수 있는 진행 표시 바와 게임 공지사항 시스템을 통해 사용자 경험을 극대화했습니다.
...
|                                           |                                         |
| ----------------------------------------- | --------------------------------------- |
| <img src="./docs/Image/Web/웹메인.gif">     | <img src="./docs/Image/런처다운로드-실행.gif">   |
...
| <img src="./docs/Image/LauncherImage/07-2_게임 유효성 검사.png">     | <img src="./docs/Image/LauncherImage/07-2_게임 유효성 검사.png">   |
| `유효성 검사` 유효성 검사1           | `유효성 검사` 유효성 검사2 |
...
|                                           |                                         |
| ----------------------------------------- | --------------------------------------- |
| <img src="./docs/Image/Web/웹 랭킹.gif">     | <img src="./docs/Image/Scenario/3.PNG">   |
| `웹 페이지` 스테이지 별 랭킹 확인           | `게임 화면` 스테이지 별 랭킹 확인 |
